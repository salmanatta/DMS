...
<body>
    <div class="card-body">
        ...
        <form class="auth-login-form mt-2" action="https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/html/ltr/vertical-collapsed-menu-template/index.html" method="POST" novalidate="novalidate">
          <div class="mb-1">
